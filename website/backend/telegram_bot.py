...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if donor:
        ...
        await update.message.reply_html(
            ...
            f"<b>Введите 6-значный код</b> из личного кабинета,\n"
            f"чтобы привязать аккаунт и получать уведомления.\n\n"
            f"<b>Пример:</b> <code>123456</code>\n\n"
            f"━━━━━━━━━━━━━━━━━━━━━━\n\n"
            f"<b>Что вы получите после привязки:</b>\n"
            f"• 🚨 Срочные запросы крови вашей группы\n"
            f"• 📊 Статус ваших откликов\n"
            f"• ⏰ Напоминания о донациях"
        )
